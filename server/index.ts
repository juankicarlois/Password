...
interface RoomEntry {
  ...
  /** Socket de cada jugador, para mandarle datos solo a él (su estado privado). */
...
wss.on('connection', (socket: WebSocket) => {
  ...
  socket.on('close', () => {
    ...
    // Recoge las salas sin humanos conectados (una sala de solo bots no debe
...
httpServer.listen(PORT, () => {
  console.log(`Password accesible escuchando en el puerto ${PORT}`);
